...
coordinates = [
    [
        [
            ...
            [-73.606133883, 45.50687600],
            [-73.605905904, 45.506773980],
            [-73.603533905, 45.505698946],
            [-73.602475870, 45.506856969],
            ...
            [-73.618446320, 45.526287943],
            [-73.618968507, 45.525698560],
            [-73.619388002, 45.525216750],
            [-73.619532966, 45.525064183],
            [-73.619686662, 45.524889290],
            [-73.619787038, 45.524770086],
            [-73.619925742, 45.524584939],
            [-73.619954486, 45.524557690],
                    ...
                    "features": [
                        {
                            ...
                            "geometry": {
                                "coordinates": [4.803301898900543, 52.367498304444695],
                                "type": "Point",
                            },
                        }
                    ],
...
plt = rx.plotly(data=fig)


def index() -> rx.Component:
    return rx.center(plt)
